...
public:
	Ellipse(int xCor, int yCor, int rX, int rY)
		: xRadius(rX), yRadius(rY), center(xCor, yCor) {}
...
public:
	...
	Picture(Picture& other)
	{
		...
		this->circles = new Circle * [cNum];
		this->rectangles = new Rectangle * [rNum];
		this->lines = new Line * [lNum];
		this->triangles = new Triangle * [tNum];
		this->ellipses = new Ellipse * [eNum];
