...
public class UpdateDeleteBenchmarks
{
    ...
    [Benchmark] public void EF_Update() => _ef.Update(_seedId, "test@mail.com");
    [Benchmark] public void Dapper_Update() => _dapper.Update(_seedId, "test@mail.com");
    [Benchmark] public void ADO_Update() => _ado.Update(_seedId, "test@mail.com");

    [Benchmark] public void EF_Delete() => _ef.Delete(_seedId);
    [Benchmark] public void Dapper_Delete() => _dapper.Delete(_seedId);
    [Benchmark] public void ADO_Delete() => _ado.Delete(_seedId);
}